...
HOME_RAW_IMG: PIL.Image = resize_img("resources//pictures//home_icon.png", (25, 25))
SCRIPT_RAW_IMG: PIL.Image = resize_img("resources//pictures//script_icon.png", (25, 25))
CONNECTION_RAW_IMG: PIL.Image = resize_img(
    "resources//pictures//connection_icon.png", (25, 25)
)
INFO_RAW_IMG: PIL.Image = resize_img("resources//pictures//info_icon.png", (25, 25))
PLAY_RAW_IMG: PIL.Image = resize_img("resources//pictures//play_icon.png", (25, 25))
PAUSE_RAW_IMG: PIL.Image = resize_img("resources//pictures//pause_icon.png", (25, 25))
...
LED_GREEN_RAW_IMG: PIL.Image = resize_img(
    "resources//pictures//led_green.png", (25, 25)
)
SETTINGS_RAW_IMG: PIL.Image = resize_img(
    "resources//pictures//settings_icon.png", (25, 25)
)
STATUS_RAW_IMG: PIL.Image = resize_img("resources//pictures//status_icon.png", (25, 25))
CONSOLE_RAW_IMG: PIL.Image = resize_img(
    "resources//pictures//console_icon.png", (30, 30)
)
SONIC_MEASURE_RAW_IMG: PIL.Image = resize_img(
    "resources//pictures//line_chart_icon.png", (25, 25)
)
