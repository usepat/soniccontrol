...
class ScriptingView(ttk.Frame):
    def __init__(self, master: ttk.Window, *args, **kwargs) -> None:
        ...
        self._menue_button: ttk.Menubutton = ttk.Menubutton(
            self._navigation_button_frame, menu=self._menue, style=ttk.DARK
        )
        ...
        self._scripting_frame: ttk.Labelframe = ttk.Labelframe(
            self._main_frame, text=const.ui.SCRIPT_EDITOR_LABEL
        )
    ...
    def _init_publish(self) -> None:
        ...
        self._script_status_frame.columnconfigure(0, weight=1)
