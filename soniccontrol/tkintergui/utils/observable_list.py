...
class ObservableList(EventManager):
    ...
    def append(self, item):
        ...
        self.emit(Event(self.EVENT_ITEM_ADDED, item=item, list_new=self._list))

    def remove(self, item):
        self._list.remove(item)
        self.emit(Event(self.EVENT_ITEM_DELETED, item=item, list_new=self._list))

    def clear(self):
        self._list.clear()
        self.emit(Event(self.EVENT_LIST_CLEARED, list_new=self._list))
