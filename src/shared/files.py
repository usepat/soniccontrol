...
class _Files:
    ...
    BIN_DIR: Final[Path] = SOURCE_DIR / "sonicpackage/bin"
    DATA_DIR: Final[Path] = ROOT_DIR / "data"
    LOG_DIR: Final[Path] = DATA_DIR / "logs"
    LOGGING_CONFIG: Final[Path] = SOURCE_DIR / "soniccontrol_gui/log_config.json"
    RESOURCES_DIR: Final[Path] = SOURCE_DIR / "soniccontrol_gui/resources"
    ...
    TRANSDUCDER_CONFIG_JSON: Final[Path] = DATA_DIR / "transducer_configs.json"
    SONICCONTROL_LOG: Final[Path] = LOG_DIR / "src.log"
